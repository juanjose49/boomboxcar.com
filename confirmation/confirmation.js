(() => {
  ...
  const copy = {
    en: {
      ...
      squareDiscount: 'Square payment discount', squareAdjustment: 'Square payment adjustment',
    ...
    es: {
      ...
      squareDiscount: 'Descuento de pago de Square', squareAdjustment: 'Ajuste de pago de Square',
