(() => {
  ...
  const copy = {
    en: {
      ...
      included: ['Two powerful speakers', 'Inflatable BoomBox', 'Two wireless microphones', 'Licensed background music through Soundtrack Your Brand'],
      scope: 'BoomBoxCar staff set up and operate the sound system. DJ and MC services are not included. Your team controls announcements, programming, and the event message.',
    ...
    es: {
      ...
      included: ['Dos bocinas potentes', 'BoomBox inflable', 'Dos micrófonos inalámbricos', 'Música ambiental con licencia a través de Soundtrack Your Brand'],
      scope: 'El personal de BoomBoxCar instala y opera el sistema de sonido. Los servicios de DJ y maestro de ceremonias no están incluidos. Tu equipo controla los anuncios, la programación y el mensaje del evento.',
