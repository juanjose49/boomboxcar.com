(() => {
  ...
  const copy = {
    en: {
      ...
      scope: 'BoomBoxCar staff set up and operate the system and provide MC support and announcements. Dedicated DJ service is not included. You control music selections, programming, and the event message.',
    ...
    es: {
      ...
      scope: 'El personal instala y opera el sistema y brinda apoyo de maestro de ceremonias y anuncios. El servicio dedicado de DJ no está incluido. Tú controlas la selección musical, la programación y el mensaje del evento.',
